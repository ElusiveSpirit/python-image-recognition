...
class Network(object):
    ...
    def train(self, training_data, epochs, mini_batch_size, eta, test_data=None):
        ...
        for j in range(epochs):
            ...
            if test_data:
                print("Epoch {} : {} / {}".format(j, self._evaluate(test_data), n_test))
            else:
                print("Epoch {} complete".format(j))

    def save_to_file(self, filename='network.json'):
        data = {
    ...
    @classmethod
    def load_from_file(cls, filename='network.json'):
    ...
    def _evaluate(self, test_data):
        ...
        test_results = [(self.recognize(x), y)
